function Ball(loc, vel, rad, col){
	...
	this.render = function(){
		...
		stroke(20, 255, 150);
		smooth();
		line(this.loc.x, this.loc.y, width/12, height/12);
		strokeWeight(1);
		var rad = random(50, 100);
		stroke(255, 0, 0);
		smooth();
		line(this.loc.x, this.loc.y, width/7, height/7);
		strokeWeight(20);
		var rad = random(50, 100);
		stroke(255, 150, 5);
		smooth();
		line(this.loc.x, this.loc.y, width/5, height/5);
		strokeWeight(1);
		var rad = random(50, 100);
		stroke(255, 255, 0);
		smooth();
		line(this.loc.x, this.loc.y, width/15, height/7);
		strokeWeight(1);
		var rad = random(50, 100);
		stroke(50, 255, 0);
		smooth();
		line(this.loc.x, this.loc.y, width/6, height/6);
		strokeWeight(1);
		var rad = random(50, 100);
		stroke(255, 0, 255);
		smooth();
